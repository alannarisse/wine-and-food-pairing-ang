...
const varietal_mappings_service_1 = require("./varietal-mappings/varietal-mappings.service");
const WINES_DATA = [
    {
...
async function bootstrap() {
    ...
    const winesService = app.get(wines_service_1.WinesService);
    const mappingsService = app.get(varietal_mappings_service_1.VarietalMappingsService);
